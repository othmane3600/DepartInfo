...
<body>
	...
	<div class="edit" style="margin-left: 300px; margin-bottom: 300px;">
		<form action="filtregroupe" method="post">


			<h2>Choisir Liste Etudiants</h2>
			<div class="form-row">
				...
				<select class="form-select" aria-label="Disabled select example" name="groupe" >
					
					<c:forEach items="${groupes}" var="g">
						
						<option value="${g.getIdGroupe()}">${g.getNom()}</option>
					</c:forEach>
				</select>

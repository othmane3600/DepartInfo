          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
               ...
               <th> <a class="btn btn-primary" href="<c:url value="/AddEtu"/>"><i class="icon_plus_alt2"></i></a></th>
               </table>
              </header>
         ...
         <tr>
                    ...
                    <td>
                      <div class="btn-group">
                        ...
                        <a class="btn btn-success" href="ModfEtu?id=<c:out value ='${Et.getId()}'/>"><i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="DelEtu?id=<c:out value='${Et.getId()}'/>"><i class="icon_close_alt2"></i></a>
                      </div>
                    </td>

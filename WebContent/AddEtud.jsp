          ...
          <div class="col-lg-12">
            <section class="panel">
              ...
              <div class="panel-body">
                <div class="form">
                  <form class="form-validate form-horizontal "  method="post" action="saveEtud">
                    <div class="form-group ">
                      <label for="fullname" class="control-label col-lg-2">Full name <span class="required">*</span></label>
                      <div class="col-lg-10">
                        <input class=" form-control" id="fullname" name="fullname" type="text" placeholder="firstname lastname" required
                        />
                      </div>
                    </div>
                    <div class="form-group ">
                      ...
                      <div class="col-lg-10">
                        <input class=" form-control" id="massar" name="massar" type="text" />
                      </div>
                    </div>
                    <div class="form-group ">
